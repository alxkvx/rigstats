...
for($x = 0; $x < $rigsnum; $x++) {
	...
	if (!$socket) {
		$html .= "<tr><td>$name</td><td>$type</td><td>$gpus</td><td colspan=2></td><td><span class=\"red\">$ip</span></td><td><span class=\"box red\">Offline</span></td></tr>";
		continue;
	}
...
$html.= "<br>Total: ". $rigsnum . " Rigs | ". $gpustotal . " GPUs | ". $ethtotal . " Mh/s" . "<br>"; 
