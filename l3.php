...
$l3 = json_decode(file_get_contents('l3list.json'),true);
...
$html = '<link href="main.css" type="text/css" rel="stylesheet"/><head><title>A: L3</title></head><body>';
