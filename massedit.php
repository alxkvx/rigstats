...
<div id=pools>
<h2>Add Pool</h2>
	<input id=url  type=\"text\" name=\"url\" value=\"url\" size=30>
	<input id=user type=\"text\" name=\"user\" size=10>
	<input id=add  type=\"submit\" value=\"ADD\"> 

<h2>Add and Switch Pool</h2>
	<input id=urlsw  type=\"text\" name=\"url\" value=\"url\" size=30>
	<input id=usersw type=\"text\" name=\"user\" size=10>
	<input id=addnswt  type=\"submit\" value=\"APPLY\"> 
...
<h2>Switch Pool</h2>
        <input id=poolid type=\"text\" name=\"user\" size=3>
